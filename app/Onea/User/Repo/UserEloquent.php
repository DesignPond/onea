<?php namespace App\Onea\User\Repo;

use App\Onea\User\Repo\UserInterface;
use App\Onea\User\Entities\User as M;
...
class UserEloquent implements UserInterface {
    ...
    public function search($term){
        ...
        return $this->user
            ...
            {
                $query->whereRaw('email REGEXP "[[:<:]]'.$term.'[A-Z0-9._-]*@"')
    ...
    public function findTypeUserByMultipleEmail($emails){

        return $this->user->whereIn('email', $emails )->get()->lists('user_type')->all();
    }
